          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{route('kgb.store')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method("post")
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input name="tgl_kgb" id="datemask" type="text" class="form-control @error('tgl_kgb') is-invalid @enderror" value="{{old('tgl_kgb')}}" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-mask placeholder="Masukkan Tanggal KGB" required>
                        @error('tgl_kgb')
                          <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                          </span>
